...
@section('navigation')
    ...
    @if($isProfessor)
        ...
        <a class="{{ $navigationClass(request()->routeIs('participant.professor.profile')) }}" href="{{ route('participant.professor.profile') }}">Perfil docente</a>
        <div class="my-3 border-t border-slate-200"></div>
    @endif
    ...
    <a class="{{ $navigationClass(request()->routeIs('participant.badges.*')) }}" href="{{ route('participant.badges.index') }}">Insignias</a>
